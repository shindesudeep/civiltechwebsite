...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      <h1>WELCOME TO DESTINY BUILDERS</h1>
      <h2>CONSTRUCTION | ARCHITECTURE | LANDSCAPE | INTERIOR</h2>
      <h2>We are team of talented designers ,builders ,promoters and providing quality construction materials making users satisfy.</h2>
      ...
      <h2>About Us</h2>
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
            <img src="https://www.constructionexec.com/assets/site_18/images/article/090220094124.jpg?width=1280" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Helping all Needy Businesses and Users with our civil technologies to  build the script of the future.</h3>
            <p class="fst-italic">
            <h4>
            We deals with the design, construction, and maintenance of the physical and naturally built environment, including public works such as roads, bridges, canals, dams, airports, sewerage systems, pipelines, structural components of buildings, and railways.
</h4></p>
            <ul>
              <li><i class="bi bi-check-circle"></i>Our  platform serves thousands of people needs every month and having a record of one of the 50 most popular civil tech websites in the world.</li>
              <li><i class="bi bi-check-circle"></i> We provide the infrastructure services and project under one website</li>
              <li><i class="bi bi-check-circle"></i> This is our create friendly platform for civil tech .</li>
            </ul>
                      </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up">
            <div class="box">
              ...
              <p><p>
            The team take care of all work and services.this is our RERA Authority’s website and the matter is that we do the work on time.</p>
</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="150">
            <div class="box">
              <span>02</span>
              <h4>Easy Access</h4>
              <p>We are here with all autorities and rules and providing you easy access to this platform with our team members to give best services from our side.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              ...
              <p>Any work we provide is both affordable and innovative by matter of quality and cost.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="150">
            <div class="box">
              ...
              <ul>
                ...
                <li>Geologists</li>
                <li class="na">Site Manager</li>
                <li class="na">Arcitect</li>
              </ul>
              <div class="btn-wrap">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Echo Sounding Inspections </a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Project Management</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Vehicle and traffic simulation</a></li>
